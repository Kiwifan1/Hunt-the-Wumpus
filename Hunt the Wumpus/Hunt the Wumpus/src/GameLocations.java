...
public class GameLocations {
       ...
       public GameLocations(Cave c) {
              ...
              while (pitLocations[1] == pitLocations[0] || pitLocations[1] == batLocations[0]
                            || pitLocations[1] == batLocations[1]) {
                     pitLocations[1] = (int) (Math.random() * 30 + 1);
              }
       ...
       public static void moveWumpus() {
              ...
              for (int i = 0; i < (int) (Math.random() * 3 + 2); i++) {
                     ...
                     while (z) {
                            boolean y = false;
                            int moveLocation = cave.tunnels(
                                          wumpusLocation)[(int) (Math.random() * cave.tunnels(wumpusLocation).length)];
       ...
       public static void moveWumpusOne() {
              int moveLocation = cave
                            .tunnels(wumpusLocation)[(int) (Math.random() * cave.tunnels(wumpusLocation).length)];
              wumpusLocation = moveLocation;
       }
       ...
       /*
        * Changes the location of the player when if the player encounters a botomless
        * pit or triggers endgame
        * 
        * @param answeredQuestions is a boolean indicating if the Player properly
