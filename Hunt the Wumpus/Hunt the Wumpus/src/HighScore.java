...
public class HighScore 
{
    ...
    */
    ...
    {
        scoreBoard = new File("Hunt the Wumpus/Hunt the Wumpus/input/HighScores.txt");    
    ...
    {
        PrintStream output = new PrintStream(new File("Hunt the Wumpus/Hunt the Wumpus/input/HighScores.txt"));
        /**
